...
namespace BasicCard.CardGameFramework
{
    ...
    /// <summary>
    /// This class is game-specific.  Creates a BasicCard hand that inherits from class hand
    /// </summary>
    public class BasicCardHand : Hand
    {
        /// <summary>
        /// This method compares two BasicCard hands
        /// </summary>
        /// <param name="otherHand"></param>
        /// <returns></returns>
        public int CompareFaceValue(object otherHand)
        {
            BasicCardHand aHand = otherHand as BasicCardHand;
        ...
        /// <summary>
        /// Gets the total value of a hand from BasicCard values
        /// </summary>
        /// <returns>int</returns>
